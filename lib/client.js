window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function planBlocker(draft, creating) {
		...
		*/
		var ModelPlanSectionController = class {
			...
			async confirmSave() {
				...
				if (planBlocker(draft, draft.creating) !== void 0) return;
				this.patchDialog({
					saving: true,
					error: null
				});
			...
			return (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					(0, react_jsx_runtime.jsxs)("div", {
						...
						}), param.key === "reasoningEffort" && reasoningEffortOptions.length > 0 ? (0, react_jsx_runtime.jsx)("select", {
		...
		*/
		...
		function triggerLabel(state, t) {
			...
			if (bound !== void 0) return `${t("seatPrefix")}${bound.name}`;
				...
				children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
					...
					children: [
						...
						(0, react_jsx_runtime.jsx)("div", {
							...
							children: state.options.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
