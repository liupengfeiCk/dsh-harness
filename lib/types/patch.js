...
function containsJsExpr(value) {
    ...
    if (Array.isArray(value))
        return value.some(containsJsExpr);
...
function parseDisablePatch(patch) {
    if (patch.id === undefined)
        throw new RestartRequiredError('a disabled override needs an id');
