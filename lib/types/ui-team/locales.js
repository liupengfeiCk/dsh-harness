...
export const en = {
    ...
    detailIntro: 'Each role binds a soul (its own prompt, injected as the child\'s persona) to a body '
...
export const zh = {
    nav: '团队',
    sectionIntro: '团队是你自定义的角色编制表，与子代理分开存储。每个角色把一个灵魂（角色自己的提示词）'
    ...
    detailTitle: '编辑团队',
    detailIntro: '每个角色把灵魂（自己的提示词，注入为子代理的 persona）绑定到一个身体（界定该角色能力范围的子代理 id）。'
