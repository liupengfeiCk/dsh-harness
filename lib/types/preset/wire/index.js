...
export function registerSubagentPresetWire(ctx) {
    ...
    const tryRegister = () => {
        ...
        if (connection === undefined)
            return;
        ctx.effect(() => connection.rpc.handle(SUBAGENT_PRESET_CHANNEL, (endpoint, payload, signal) => dispatchSubagentPreset(ctx.get('subagentPresets'), endpoint, payload, signal), { authority: AUTHORITY }), 'dsh-subagent-preset: /subagent-preset rpc channel');
    };
    tryRegister();
