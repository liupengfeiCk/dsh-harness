...
function PlanDialog(props) {
    const { draft, creating, catalog, rows, t, setDialogId, setDialogName, setDialogProvider, setDialogModel, setParamKey, setParamValue, setReasoningEffort, addParam, removeParam, confirm, cancel } = props;
    ...
    return (_jsx(Modal, { open: true, onClose: cancel, title: creating ? t('createTitle') : t('editTitle'), closeLabel: t('close'), description: creating ? t('createIntro') : t('editIntro'), className: css.dialog, contentClassName: css.dialogScroll, footer: (_jsxs(_Fragment, { children: [_jsx(Button, { variant: "outline", disabled: draft.saving, onClick: cancel, children: t('cancel') }), _jsx(Button, { disabled: draft.saving || blocker !== undefined, onClick: confirm, children: draft.saving ? t('saving') : t('save') })] })), children: _jsxs("div", { className: css.dialogFields, children: [creating ? (_jsxs("div", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('idLabel') }), _jsx("input", { className: css.input, value: draft.id, placeholder: t('idPlaceholder'), onChange: e => setDialogId(e.target.value) })] })) : null, _jsxs("div", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('nameLabel') }), _jsx("input", { className: css.input, value: draft.name, placeholder: t('namePlaceholder'), onChange: e => setDialogName(e.target.value) })] }), _jsxs("div", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('modelLabel') }), catalogFailed
