        ...
        class HarnessHotTree extends Include {
            ...
            import(name, getOuterStack) {
                ...
                if (r && typeof r.then === 'function') {
                    return r.then((m) => { writeFileSync('/tmp/harness-hot-import-debug.json', JSON.stringify({ name, ok: true, keys: m ? Object.keys(m) : null })); return m; }, (e) => { writeFileSync('/tmp/harness-hot-import-debug.json', JSON.stringify({ name, ok: false, error: e instanceof Error ? `${e.message}\n${e.stack}` : String(e) })); throw e; });
                }
