...
*/
async function dispatchHarnessHot(service, endpoint, payload, signal) {
	try {
...
//#endregion
export { ActivationTimeout, HARNESS_HOT_CHANNEL, HOT_DIR, HOT_MOUNT_TIMEOUT_MS, HOT_ROW_PREFIX, HarnessHot, HotManager, RestartRequiredError, apply, clearPackageLoadCache, deriveProfileDir, dispatchHarnessHot, parsePatch, registerHarnessHotWire };
