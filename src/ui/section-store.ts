...
const INITIAL: ModelPlanSectionState = {
  status: 'idle',
  error: null,
  authorable: false,
  rows: [],
...
function seedParams(): ParamDraft[] {
...
function paramsToDraft(params: WireParams): ParamDraft[] {
...
export class ModelPlanSectionController {
  ...
  readonly store: SnapshotStore<ModelPlanSectionState> = createSnapshotStore(INITIAL)
  ...
  private set(patch: Partial<ModelPlanSectionState>): void {
    this.store.set({ ...this.store.getSnapshot(), ...patch })
  }

  private patchDialog(patch: Partial<PlanDraft>): void {
...
function paramsToWire(params: readonly ParamDraft[]): WireParams {
