...
export type AgentPresetSettingsKey =
  ...
  | 'edit' | 'editTitle' | 'editIntro' | 'save' | 'saving'
  | 'personaText' | 'personaTextPlaceholder'
  | 'delegation.provider' | 'delegation.providerPlaceholder'
  | 'delegation.toolName' | 'delegation.toolNamePlaceholder'
  | 'delegation.backgroundMode' | 'delegation.backgroundModePlaceholder'
  | 'delegation.enableRunInBackground' | 'delegation.enableRunInBackgroundPlaceholder'
  | 'delegation.maxDepth' | 'delegation.maxDepthPlaceholder'
  | 'delegation.enabled' | 'delegationTitle' | 'toolsTitle' | 'toolExprDisabled'
  | 'delegation.noBackgroundSupport'
  | 'toolsTitle' | 'toolInstalled' | 'toolUninstalled'
...
export const en: Record<AgentPresetSettingsKey, string> = {
  ...
  editIntro:
    'Changes apply to sessions started from now on; a session already running keeps the composition it began with.',
  save: 'Save',
  saving: 'Saving…',
