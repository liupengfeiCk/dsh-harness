 ...
 */
export const NON_DISTILLABLE_SOURCE = 'compaction-summary' as const
 ...
 */
export function summarySourceMetadata(level: number): Readonly<{ source: typeof NON_DISTILLABLE_SOURCE; level: number }> | undefined {
 ...
 */
export function isNonDistillable(metadata: unknown): boolean {
  if (typeof metadata !== 'object' || metadata === null) return false
  return (metadata as { source?: unknown }).source === NON_DISTILLABLE_SOURCE
}
