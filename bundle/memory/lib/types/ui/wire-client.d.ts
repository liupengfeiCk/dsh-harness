...
export interface MemoryWire {
    assets(payload: {
        scope: WireAssetScope;
        isolation?: WireIsolation;
    }, signal?: AbortSignal): Promise<RpcResult<WireScopeAssets>>;
    assetRead(payload: {
        ref: string;
    ...
    status(payload: {
        scope: WireAssetScope;
        isolation?: WireIsolation;
    }, signal?: AbortSignal): Promise<RpcResult<WireScopeStatus>>;
...
export declare function createMemoryWire(rpc: ClientConnectionRpc): MemoryWire;
