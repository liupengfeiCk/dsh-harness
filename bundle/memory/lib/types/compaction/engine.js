 ...
 */
import { NoCompressibleHistoryError, NoCoverageError } from "./types.js";
import { partitionLayers, resolveBudgets, selectCompressibleRange, } from "./select.js";
import { recursiveCoarsen, withinCap } from "./coarsen.js";
...
export class CompactionEngine {
    ...
    async coarsen(sessionId, summaries, crossSessionMemoryTokens, windowTokens) {
        ...
        if (withinCap(summaries, summaryCap))
            return [...summaries];
