...
export interface Summarizer {
     ...
     */
    summarize(span: RawSpan, fromLevel: number, ctx?: {
...
export declare class CompactionConfigError extends CompactionError {
}
/** The compaction engine is asked to operate on an empty or invalid history. */
export declare class NoCompressibleHistoryError extends CompactionError {
}
/** A persisted layer could not be recovered (missing/corrupt), non-fatal. */
export declare class LayerRecoveryError extends CompactionError {
}
/** A requested raw/summary retrieval range has no stored coverage. */
export declare class NoCoverageError extends CompactionError {
}
/**
 ...
 */
export declare class CoarseningFloorError extends CompactionError {
