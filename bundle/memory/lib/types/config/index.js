...
import { Config, DEFAULT_MEMORY_SETTINGS } from "./schema.js";
...
let current = { ...DEFAULT_MEMORY_SETTINGS };
 ...
 */
export function applyMemorySettings(base) {
 ...
 */
export function installMemorySettings(ctx) {
