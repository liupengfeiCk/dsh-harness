...
export interface MemoryPromptStore {
    ...
    deleteMemoryPrompts?(ids: string[], operatorId?: string): Promise<MemoryPromptDeleteResult> | MemoryPromptDeleteResult;
    getMemoryPromptSettings?(ids: string[]): Promise<MemoryPromptSettingRecord[]> | MemoryPromptSettingRecord[];
    listMemoryPromptSettings?(filter: MemoryPromptSettingListFilter): Promise<MemoryPromptSettingRecord[]> | MemoryPromptSettingRecord[];
    upsertMemoryPromptSettings?(records: MemoryPromptSettingRecord[], logs: MemoryPromptSettingLogRecord[]): Promise<void> | void;
    clearMemoryPromptSettings?(ids: string[], logs: MemoryPromptSettingLogRecord[]): Promise<void> | void;
    queryMemoryPromptSettingLogs?(filter: MemoryPromptSettingLogFilter): Promise<MemoryPromptSettingLogRecord[]> | MemoryPromptSettingLogRecord[];
}
export declare function buildMemoryPromptSettingId(target: {
    teamId?: string;
    agentId?: string;
}, layer: MemoryPromptLayer): string;
export declare function getMemoryPromptTargetType(target: {
    teamId?: string;
    agentId?: string;
