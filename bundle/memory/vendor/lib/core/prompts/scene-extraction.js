...
function getSceneSystemPrompt(maxScenes, promptMode = "chat") {
...
export function buildSceneExtractionPrompt(params) {
    const { memoriesJson, sceneSummaries, currentTimestamp, sceneCountWarning, existingSceneFiles, maxScenes, promptMode = "chat", } = params;
