...
export interface MemoryGenerationRefStore {
    ...
    getMemoryGenerationRef?(layer: MemoryGenerationLayer, memoryId: string): Promise<MemoryGenerationRefRecord | null> | MemoryGenerationRefRecord | null;
}
export declare function buildMemoryGenerationRefId(layer: MemoryGenerationLayer, memoryId: string): string;
