...
export declare const StoragePaths: {
    ...
    readonly persona: "persona.md";
    /** L2 scene blocks directory */
    readonly sceneBlocksDir: "scene_blocks/";
    /** L0 conversations directory */
    readonly conversationsDir: "conversations/";
    /** L1 memory records directory */
    readonly recordsDir: "records/";
    /** Metadata directory */
    readonly metadataDir: ".metadata/";
    /** Scene index */
    readonly sceneIndex: ".metadata/scene_index.json";
    /** Pipeline checkpoint */
    readonly checkpoint: ".metadata/checkpoint.json";
    /** Metadata manifest */
    readonly manifest: ".metadata/manifest.json";
    /** Instance ID */
    readonly instanceId: ".metadata/instance_id";
    /** Backup directory */
    readonly backupDir: ".backup/";
    /** Build scene block path */
    readonly sceneBlock: (name: string) => string;
    /** Build conversation JSONL path */
    readonly conversation: (date: string) => string;
    /** Build memory record JSONL path */
    readonly record: (date: string) => string;
    /** Build persona backup path */
    readonly personaBackup: (index: number) => string;
    /** Build scene block backup path */
    readonly sceneBlockBackup: (index: number, name: string) => string;
};
