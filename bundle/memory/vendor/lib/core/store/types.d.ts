...
export type { IsolationContext, IsolationFilter, IsolationConfig, } from "./isolation.js";
export { DEFAULT_ISOLATION_ID, LEGACY_ISOLATION_PLACEHOLDER, DEFAULT_ISOLATION_CONFIG, assertIsolation, buildIsolationWhere, rowMatchesIsolation, IsolationError, } from "./isolation.js";
...
export interface IMemoryStore extends MemoryPromptStore, MemoryGenerationRefStore {
    ...
    createAgent?(input: Omit<AgentEntity, "created_at" | "updated_at" | "status" | "visibility"> & {
        agent_id?: string;
        status?: AgentStatus;
        visibility?: AgentVisibility;
