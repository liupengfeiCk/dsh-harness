 ...
 * 当配置要求使用远程后端时会抛出明确错误。
 */
export type { IStateBackend, PipelineSessionState, TimerEntry, TaskPayload, CaptureAtomicParams, CaptureAtomicResult, } from "./types.js";
 ...
 *     DSH 单机部署仅使用本地状态后端。）
 */
export declare function createStateBackend(config: StateBackendConfig): Promise<IStateBackend>;
