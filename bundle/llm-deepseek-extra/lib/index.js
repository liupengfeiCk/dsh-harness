...
* @module dsh-llm-deepseek-extra/translate
*/
/**
...
*
* @module dsh-llm-deepseek-extra/adapter
*/
...
*
* HARSH-owned replacement for @deepseek-ai/dsh-llm-deepseek (换件): keeps the
* official `name = 'llm-deepseek'` so the `llm-deepseek` user-settings section
* feeds it identically, but its serializer additionally forwards the
* `LlmCallConfig.extra` passthrough bag into the wire request top level — the
* capability the official adapter lacks. The plugin is registered under the
* distinct composition row id `llm-deepseek-extra`.
* @module dsh-harness-llm-deepseek-extra-bundle
*/
