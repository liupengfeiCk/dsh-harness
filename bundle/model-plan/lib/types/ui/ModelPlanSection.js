...
function PlanCard(props) {
    ...
    return (_jsxs("li", { className: `${css.card} ${broken ? css.cardBroken : ''}`, children: [_jsxs("div", { className: css.cardHead, children: [_jsx("span", { className: css.cardName, children: row.id }), row.isDefault
...
function ParamRow(props) {
    ...
    return (_jsxs("div", { className: css.paramRow, children: [_jsxs("div", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('paramKeyLabel') }), _jsx("input", { className: css.input, value: param.key, placeholder: t('paramKeyPlaceholder'), onChange: e => onKey(index, e.target.value) })] }), _jsxs("div", { className: css.field, children: [_jsx("span", { className: css.fieldLabel, children: t('paramValueLabel') }), _jsx("input", { className: css.input, value: param.value, placeholder: t('paramValuePlaceholder'), onChange: e => onValue(index, e.target.value) })] }), _jsx(Tooltip, { label: t('removeParam'), side: "top", children: _jsx("button", { type: "button", className: `${css.iconButton} ${css.iconDanger}`, onClick: () => onRemove(index), "aria-label": t('removeParam'), children: _jsx(IconTrashOutline16, {}) }) })] }));
}
