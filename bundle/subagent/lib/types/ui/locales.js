...
export const en = {
    nav: 'Subagents',
    sectionIntro: 'Subagents are your own helper agents, stored independently from agent presets. '
    ...
    createIntro: 'The whole subagent is copied on this machine. The identifier becomes its directory name '
        + 'and cannot be changed later; everything else is edited in the subagent\'s own files.',
    copyOf: 'Copied from',
    delete: 'Delete',
    deleteTitle: 'Delete this subagent?',
    deleteDescription: 'The subagent directory is deleted. A delegated child already running on it keeps working; '
    ...
    editIntro: 'Changes apply to delegations from now on; a child already running keeps the composition it '
        + 'began with.',
    save: 'Save',
    saving: 'Saving…',
    cancel: 'Cancel',
    ...
    inheritParentHint: 'When on, the delegated child layers this subagent on top of the main agent\'s tools and prompt. '
...
export const zh = {
    nav: '子代理',
    sectionIntro: '子代理是你自定义的帮手 Agent，与 Agent 预设完全分开存储。主 Agent 可按名称把工作委派给已启用的子代理。'
    ...
    inheritParentHint: '开启后，派出的子 agent 在主 agent 的工具和提示词之上叠加本子代理自己的配置；'
        + '关闭后仅使用本子代理自己的配置。',
    toolsTitle: '工具',
    toolsLabel: '工具',
    toolInstalled: '已启用',
