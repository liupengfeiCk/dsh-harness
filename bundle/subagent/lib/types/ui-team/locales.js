...
export const en = {
    nav: 'Teams',
    sectionIntro: 'Teams are your own role rosters ("编制表"), stored independently from subagents. '
    ...
    createIntro: 'A team is one directory holding a team.yml. The identifier becomes its directory name '
        + 'and cannot be changed later; the roster of roles is edited in the team\'s detail view.',
    detailTitle: 'Edit team',
    detailIntro: 'Each role binds a prompt (its own, injected as the child\'s persona) to a subagent '
...
export const zh = {
    nav: '团队',
    sectionIntro: '团队是你自定义的角色编制表，与子代理分开存储。每个角色把提示词（角色自己的）'
    ...
    detailTitle: '编辑团队',
    detailIntro: '每个角色把提示词（自己的，注入为子代理的 persona）绑定到一个子代理（界定该角色能力范围的子代理 id）。'
